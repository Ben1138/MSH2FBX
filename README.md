...
### Examples
This will convert rep_inf_ep3trooper.msh to rep_inf_ep3trooper.fbx, ignoring Shadow Volumes:<br />
```MSH2FBX.exe -m C:/BF2_ModTools/assets/sides/rep/msh/rep_inf_ep3trooper.msh -b C:/BF2_ModTools/assets/Animations/SoldierAnimationBank/human_0/basepose.msh -d rep_inf_ep3trooper.fbx -i Mesh_Lowrez Mesh_ShadowVolume```
<br />
...
```MSH2FBX.exe -m C:/BF2_ModTools/assets/sides/rep/msh/rep_inf_ep3trooper.msh -b C:/BF2_ModTools/assets/Animations/SoldierAnimationBank/human_0/basepose.msh -oa C:/BF2_ModTools/assets/Animations/SoldierAnimationBank/human_0 -d rep_inf_ep3trooper.fbx -i Mesh_Lowrez Mesh_ShadowVolume```<br />
